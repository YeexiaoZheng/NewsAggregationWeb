...
const newsGet = (db, url) => {
    common.request(url, (err, res, body) => {
        ...
        try {
            ...
            else news.author = eval(formats.author_format).split('责编：').pop().replace('\n', '').trim()
